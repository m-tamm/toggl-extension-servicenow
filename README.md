...
4. Select this folder: `/Users/manueltamm/projects/acp/toggl-extension`.
...
## 3) Change the target input selector

The import target is defined in `popup.js`:
...
```bash
cd /Users/manueltamm/projects/acp/toggl-extension
